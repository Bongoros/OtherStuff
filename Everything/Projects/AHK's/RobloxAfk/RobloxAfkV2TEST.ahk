...
PixelSearch, Px, Py, 854, 365, 1036, 589, 6aadff, 0, fast RGB ;blue
    If ErrorLevel =0
    {
        ...
        Loop,
        {
        PixelSearch, Ix, Iy, 1314, 789, 1612, 898, 23b14d, 0, fast RGB ;green
        If ErrorLevel =0
        {
            WinActivate, Roblox
            Sleep, 1000
            MouseClick, left, 769, 887
            Sleep, 1500
            break
        }
            If ErrorLevel =1
    {
        ...
        PixelSearch, Ix, Iy, 1314, 789, 1612, 898, ed1b24, 0, fast RGB ;red
        If ErrorLevel =0
        {
            WinActivate, Roblox
            Sleep, 1000
            MouseClick, left, 1150, 887
            Sleep, 1500
            break
        }
